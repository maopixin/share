(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    } !function (t) { if (document.addEventListener)
        { if (~["complete", "loaded", "interactive"].indexOf(document.readyState))
            { setTimeout(t, 0); }
        else {
            var l = function () { document.removeEventListener("DOMContentLoaded", l, !1), t(); };
            document.addEventListener("DOMContentLoaded", l, !1);
        } }
    else
        { document.attachEvent && (e = t, i = h.document, a = !1, (o = function () { try {
            i.documentElement.doScroll("left");
        }
        catch (t) {
            return void setTimeout(o, 50);
        } c(); })(), i.onreadystatechange = function () { "complete" == i.readyState && (i.onreadystatechange = null, c()); }); } function c() { a || (a = !0, e()); } var e, i, a, o; }(function () { var t, l, c, e, i, a; (t = document.createElement("div")).innerHTML = o, o = null, (l = t.getElementsByTagName("svg")[0]) && (l.setAttribute("aria-hidden", "true"), l.style.position = "absolute", l.style.width = 0, l.style.height = 0, l.style.overflow = "hidden", c = l, (e = document.body).firstChild ? (i = c, (a = e.firstChild).parentNode.insertBefore(i, a)) : e.appendChild(c)); }); }(window);
